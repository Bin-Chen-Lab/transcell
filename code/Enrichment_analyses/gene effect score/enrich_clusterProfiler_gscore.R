...
gscore_gene <- read.csv(file = '/Users/shanjuyeh/Desktop/Project/GeneExp_prediction/code/enrichment_analyses/gscore/gscore_rmse_largerthan_Q3.csv')
GO <- enrichGO(gene=gscore_gene$symbol %>% unique %>% as.character() ,keyType='SYMBOL',OrgDb=org.Hs.eg.db,ont='BP')
#dotplot(GO,showCategory=10) + theme(axis.text.y = element_text(size=15))
#ggsave(filename = '/Users/shanjuyeh/Desktop/Project/GeneExp_prediction/code/enrichment_analyses/gscore/gscore.jpg',width = 15,height=10)
...
ggsave(filename = '/Users/shanjuyeh/Desktop/Project/GeneExp_prediction/code/enrichment_analyses/gscore/gscore_Q1.jpg', width = 20,height=8)
ggsave(filename = '/Users/shanjuyeh/Desktop/Project/GeneExp_prediction/code/enrichment_analyses/gscore/gscore_Q3.jpg', width = 20,height=8)
