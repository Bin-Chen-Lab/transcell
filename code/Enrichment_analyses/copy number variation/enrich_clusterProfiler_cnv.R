...
cnv_gene <- read.csv(file = '/Users/shanjuyeh/Desktop/Project/GeneExp_prediction/code/enrichment_analyses/cnv/cnv_rmse_largerthan_Q3.csv')
GO <- enrichGO(gene=cnv_gene$symbol %>% unique %>% as.character() ,keyType='SYMBOL',OrgDb=org.Hs.eg.db,ont='BP')
...
#          legend.title = element_text(size=18, face="bold") , aspect.ratio=10/5 )  + xlab('Gene Ratio') + ylab('') 
#   p
# }
...
ggsave(filename = '/Users/shanjuyeh/Desktop/Project/GeneExp_prediction/code/enrichment_analyses/cnv/cnv_Q1.jpg', width = 20,height=8)
ggsave(filename = '/Users/shanjuyeh/Desktop/Project/GeneExp_prediction/code/enrichment_analyses/cnv/cnv_Q3.jpg', width = 25,height=8)
