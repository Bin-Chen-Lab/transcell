...
#### choose 2000 sensi name to make prediction
#sensi_name = random.sample(sensi_names, 2000)
#sensi_name_df = pd.DataFrame({'sensi_name' : pd.Series(sensi_name)})
#sensi_name_df.to_csv('/Users/shanjuyeh/Desktop/Project/GeneExp_prediction/code/sensitivity/parallel/scaleup_KS5000/sensi_name.csv')
